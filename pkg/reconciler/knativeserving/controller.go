...
func NewControllerWithExtension(generator func(ctx context.Context) common.Extension) func(context.Context, configmap.Watcher) *controller.Impl {
...
func NewController(ctx context.Context, cmw configmap.Watcher) *controller.Impl {
	return NewControllerWithExtension(func(context.Context) common.Extension { return nil })(ctx, cmw)
}
